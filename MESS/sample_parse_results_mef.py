#!/usr/bin/python #make sure this is doing what you want
"""
...
#add path to me_parser.py (if necessary)
#sys.path.append( "/home/fuller/Documents/PCFC/CompChem/PAPR/tools/ANL/" )
...
##if dsarrfit.x_cfg not already in directory:
## copy new plog executable to the path of the source file
#path = os.path.abspath(os.path.dirname(me_dot_out))

#command = 'cp /home/fuller/Documents/PCFC/CompChem/PAPR/tools/ANL/dsarrfit.x_cfg ' + path 
#print (command)
#os.system(command)
